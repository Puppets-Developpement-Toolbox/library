...
<?php endif; ?>
  <div class="overflow-x-clip">
    ...
    <header class="laptop:grid laptop:grid-cols-12 laptop:gap-6">
        ...
        <aside class="hidden
                      laptop:col-span-4 laptop:self-end laptop:flex laptop:justify-end laptop:items-center laptop:gap-4">
          <div class="[ swiper__dashboard ]
                      flex gap-2">
            <button type="button"
                    class="[ swiper-button-prev ]
                          group/btn
                          shrink-0 inline-block !static !left-6 !size-12 !m-0
            ...
            <button type="button"
                    class="[ swiper-button-next ]
                          group/btn
                          shrink-0 inline-block !static !right-6 !size-12 !m-0
                          rounded-full border-1 border-primary bg-transparent
                          !text-primary
                          group-[&]/on-primary:!text-white group-[&]/on-primary:border-white
                          after:!content-none">
